...
h21 = streams.at['OPump-OEvap1', 'H']
h11 = streams.at['Comp1-Evap1', 'H']
h22 = prop.t_p(streams.at['Comp1-Evap1', 'T']-10,streams.at['OPump-OEvap1', 'P'],streams.at['OCool-OPump', 'X'])['H']
h12 = prop.t_p(Tcomp1,streams.at['Comp1-Evap1', 'P'],Gas)['H']
...
streams.at['OEvap1-OEvap2', 'H'] = h22
...
#evap2
streams.at['Evap2-Cool', 'H'] = streams.at['Reg-Evap2', 'H'] - (G_orc*(H22-streams.at['OEvap1-OEvap2', 'H']))
...
plt.plot(Q_co2_evap2,T_co2_evap2,color="purple")
plt.plot(Q_orc_evap2,T_orc_evap2,color="orange")
plt.plot(Q_co2_evap1+Q_co2_evap2[-1],T_co2_evap1,color="red")
plt.plot(Q_orc_evap1+Q_orc_evap2[-1],T_orc_evap1,color="blue")
plt.show()
