...
streams.at['Heat-Turb', 'P'] = Pk*pi - dP_evap - dP_rec
...
#turb
streams.at['Turb-Reg', 'P'] = Pk + dP_rec + dP_evap + dP_cool
...
#evap1
streams.at['Evap1-Cool2', 'P'] = Pk*pi**0.5 - dP_evap
streams.at['Evap1-Cool2', 'X'] = Gas
streams.at['Evap1-Cool2', 'G'] = G0
streams.at['Evap1-Cool2', 'T'] = Tcomp1
streams.at['Evap1-Cool2', 'H'] = prop.t_p(streams.at['Evap1-Cool2', 'T'],streams.at['Evap1-Cool2', 'P'],streams.at['Evap1-Cool2', 'X'])['H']
streams.at['Evap1-Cool2', 'Q'] = prop.t_p(streams.at['Evap1-Cool2', 'T'],streams.at['Evap1-Cool2', 'P'],streams.at['Evap1-Cool2', 'X'])['Q']
streams.at['Evap1-Cool2', 'S'] = prop.t_p(streams.at['Evap1-Cool2', 'T'],streams.at['Evap1-Cool2', 'P'],streams.at['Evap1-Cool2', 'X'])['S']

#cool2
streams.at['Cool2-Comp2', 'P'] = Pk*pi**0.5 - dP_evap - dP_cool
streams.at['Cool2-Comp2', 'X'] = Gas
streams.at['Cool2-Comp2', 'G'] = G0
streams.at['Cool2-Comp2', 'T'] = Tmin
streams.at['Cool2-Comp2', 'H'] = prop.t_p(streams.at['Cool2-Comp2', 'T'],streams.at['Cool2-Comp2', 'P'],streams.at['Cool2-Comp2', 'X'])['H']
streams.at['Cool2-Comp2', 'Q'] = prop.t_p(streams.at['Cool2-Comp2', 'T'],streams.at['Cool2-Comp2', 'P'],streams.at['Cool2-Comp2', 'X'])['Q']
streams.at['Cool2-Comp2', 'S'] = prop.t_p(streams.at['Cool2-Comp2', 'T'],streams.at['Cool2-Comp2', 'P'],streams.at['Cool2-Comp2', 'X'])['S']

#comp2
streams.at['Comp2-Reg', 'P'] = Pk*pi
streams.at['Comp2-Reg', 'X'] = Gas
streams.at['Comp2-Reg', 'G'] = G0
Ht = prop.p_s(streams.at['Comp2-Reg', 'P'], streams.at['Cool2-Comp2', 'S'], streams.at['Comp2-Reg', 'X'])['H']
streams.at['Comp2-Reg', 'H'] = streams.at['Cool2-Comp2', 'H'] + (Ht - streams.at['Cool2-Comp2', 'H'])/KPDcomp
...
#reg cold
streams.at['Reg-Heat', 'P'] = streams.at['Comp2-Reg', 'P'] - dP_rec
...
streams.at['OEvap1-OEvap2', 'H'] = (G0*(streams.at['Comp1-Evap1', 'H']-streams.at['Evap1-Cool2', 'H']))/streams.at['OEvap1-OEvap2', 'G'] + streams.at['OPump-OEvap1', 'H']
...
#ORC Evap 3
streams.at['OEvap3-OTurb', 'P'] = pi_orc*Pk_orc - dPpot_orc
...
streams.at['Evap3-Cool', 'P'] = Pk + dP_evap
...
Ht = prop.p_s(streams.at['OTurb-OCool', 'P'], streams.at['OEvap3-OTurb', 'S'], streams.at['OTurb-OCool', 'X'])['H']
streams.at['OTurb-OCool', 'H'] = streams.at['OEvap3-OTurb', 'H'] - (streams.at['OEvap3-OTurb', 'H']-Ht)*KPDturb_orc
...
H_co2_evap1 = np.linspace(streams.at['Comp1-Evap1', 'H'], streams.at['Evap1-Cool2', 'H'], n)
for i in range(0, n):
    T_co2_evap1[i] = prop.h_p(H_co2_evap1[i], streams.at['Evap1-Cool2', 'P'], Gas)["T"]
Q_co2_evap1 = -(H_co2_evap1-streams.at['Comp1-Evap1', 'H'])*streams.at['Evap1-Cool2', 'G']
...
H_orc_evap3 = np.linspace(streams.at['OEvap2-OEvap3', 'H'], streams.at['OPump-OEvap1', 'H'], n)
for i in range(0, n):
    T_orc_evap3[i] = prop.h_p(H_orc_evap3[i], streams.at['OEvap2-OEvap3', 'P'], streams.at['OEvap2-OEvap3', 'X'])["T"]
Q_orc_evap3 = -(H_orc_evap3-streams.at['OEvap2-OEvap3', 'H'])*G_orc*(1-x)
...
H_orc_evap2 = np.linspace(streams.at['OEvap3-OTurb', 'H'], streams.at['OEvap2-OEvap3', 'H'], n)
for i in range(0, n):
    T_orc_evap2[i] = prop.h_p(H_orc_evap2[i], streams.at['OEvap2-OEvap3', 'P'], streams.at['OEvap2-OEvap3', 'X'])["T"]
Q_orc_evap2 = -(H_orc_evap2-streams.at['OEvap3-OTurb', 'H'])*G_orc
# plt.plot(Q_co2_evap2,T_co2_evap2,color="brown")
# plt.plot(Q_orc_evap2,T_orc_evap2,color="blue")
# plt.plot(Q_co2_evap3+Q_co2_evap2[-1],T_co2_evap3,color="red")
# plt.plot(Q_orc_evap3+Q_orc_evap2[-1],T_orc_evap3,color="orange")
# plt.show()

NCO2_C1 = G0 * (streams.at['Comp1-Evap1', 'H'] - streams.at['Cool-Comp1', 'H'])
NCO2_C2 = G0 * (streams.at['Comp2-Reg', 'H'] - streams.at['Cool2-Comp2', 'H'])
NCO2_Turb = G0 * (streams.at['Heat-Turb', 'H'] - streams.at['Turb-Reg', 'H'])
NCO2_Heat = G0 * (streams.at['Heat-Turb', 'H'] - streams.at['Reg-Heat', 'H'])
Norc_turb = G_orc * (streams.at['OEvap3-OTurb', 'H'] - streams.at['OTurb-OCool', 'H'])
Norc_pump = G_orc * (streams.at['OPump-OEvap1', 'H'] - streams.at['OCool-OPump', 'H'])

KPD = 0.99 * 0.99 * (NCO2_Turb + Norc_turb - NCO2_C1 - NCO2_C2 - Norc_pump) / NCO2_Heat * 100
print(KPD)
